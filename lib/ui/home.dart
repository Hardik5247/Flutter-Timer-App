...
import 'package:flutter_app/resources/new_project_dialog.dart';
import 'package:flutter_app/ui/project_page.dart';
                ...
                RichText(
                  ...
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                          text: hrs,
                          style: TextStyle(fontSize: 38.0, height: 0.9)),
                      TextSpan(
                          text: mins,
                          style: TextStyle(fontSize: 25.0, height: 0.9)),
                      TextSpan(
                          text: secs,
                          style: TextStyle(fontSize: 15.0, height: 0.9))
                    ],
                  ),
                ),
                Text(
